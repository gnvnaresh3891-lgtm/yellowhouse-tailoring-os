...
export const ROLE_PERMISSIONS: Record<UserRole, RolePermissions> = {
  ...
  EMBROIDERY_ARTISAN: {
    allowedRoutes: ['/production', '/measurements', '/bidding', '/equipment', '/stylists'],
    defaultLanding: '/production',
  },
  SALES_FRONT_DESK: {
    allowedRoutes: ['/dashboard', '/customers', '/measurements', '/orders', '/marketplace', '/stylists', '/supply'],
    defaultLanding: '/orders',
  },
  QUALITY_INSPECTOR: {
    allowedRoutes: ['/dashboard', '/orders', '/production', '/measurements', '/marketplace', '/supply', '/equipment'],
    defaultLanding: '/production',
  },
  CUSTOMER_VIEW: {
    allowedRoutes: ['/orders', '/measurements', '/marketplace', '/stylists'],
    defaultLanding: '/orders',
  },
};
